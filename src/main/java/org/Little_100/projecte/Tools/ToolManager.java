...
public class ToolManager {
    ...
    private ItemStack createToolItem(Material baseMaterial, String id, int customModelData, String displayNameKey, double attackDamage, double attackSpeed) {
        ...
        if (meta != null) {
            ...
            container.set(new NamespacedKey(plugin, "projecte_charge"), PersistentDataType.INTEGER, 0);
    ...
    public void updateLore(ItemStack item) {
        ...
        Integer charge = container.get(new NamespacedKey(plugin, "projecte_charge"), PersistentDataType.INTEGER);
        if (charge != null) {
    ...
    public int getCharge(ItemStack item) {
        ...
        PersistentDataContainer container = meta.getPersistentDataContainer();
        return container.getOrDefault(new NamespacedKey(plugin, "projecte_charge"), PersistentDataType.INTEGER, 0);
    }
    ...
    public void updateToolEfficiency(ItemStack tool) {
        ...
        PersistentDataContainer container = meta.getPersistentDataContainer();
        int charge = container.getOrDefault(new NamespacedKey(plugin, "projecte_charge"), PersistentDataType.INTEGER, 0);
